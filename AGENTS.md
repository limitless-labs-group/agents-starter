...
| `npm run cross-market-mm:find-pairs` | Liquidity-ranked equivalent-market shortlist (flags polarity risk) |
| `npm run cross-market-mm:preflight` | Validate auth/funding/approvals/pairs — the gate before live |
